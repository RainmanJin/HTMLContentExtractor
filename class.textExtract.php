...
class textExtract {
        ...
        /**
         * record the web page's title
         * @var string
         */
        public $title = '';		
		
        /**
         * record the web page's description
         * @var string
         */
        public $description = '';				
        ...
        function getPageCode() {
				...
				$this->title = $this->getTitle($this->rawPageCode);
				$this->description = $this->getDescription($this->rawPageCode);
        }
		...
		function getImage($text)
		{
			...
			preg_match_all('/{\{([\w\W]*?)}\}/si', $text, $matches);
			if (sizeof($matches) >= 2)
			{
				$image = $matches[0][1];
			}
        ...
        function getPlainText() {
				...
				$this->image = $this->getImage($this->text);		
                return '{"title": "'.$this->title.'", "description": "'.$this->description.'", "url": "'.$this->url.'", "image": "'.$this->image.'"}';
        }
}
?>
